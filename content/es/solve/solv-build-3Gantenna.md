...
**En esta solución en particular construiremos una antena con materiales de fácil acceso que permitirá aumentar la intensidad de la señal 3G y 4G de un celular o un modem tipo MiFi.** 

A continuación, te vas a encontrar un instructivo que trata de ser lo más preciso y detallado posible para que puedas sentirte acompañado y seguro a medida que avanzas en este cacharreo. 

El tiempo estimado de construcción es de unas **6 a 7 horas** y consta de **8 momentos,** pero no te asustes, puedes hacer la antena de a pocos y con la ayuda de otras personas, recuerda que en SOLE Voltaje queremos promover el uso colectivo de internet. Tambien hicimos un video con los mismo pasos por si te facilita seguir la instrucción por este medio.

## ¿Para qué sirve?

En esta receta, vamos a construir una **antena casera** preparada para recibir ondas que portan la [señal 3G/4G](es/glossary/antena-3-4g-3-4g-antenna-conceptorio) - las de Internet móvil - para así mejorar la calidad de la conexión desde tu teléfono, o un módem compartido ([MiFi](es/glossary/modem-mifi-mifi-modem-conceptorio)). 
...
- **Materiales**
    ...
    2. 50 cm de canaleta plástica.
    3. Pegante epóxico de secado rápido.
    4. Buena onda.
    5. 10 mt de cable coaxial.
    6. 2 prensas o sargentos.
    7. 2 pinzas de presión
    8. 20 cm de alambre de cobre.
    9. Una regla (aún mejor si tienes un calibrador “pie de rey”, esté te permite ser más exacto).
    10. Segueta (Si te consigues una pulidora eléctrica con un disco de corte fino, ahorras un buen tiempo).
    11. Mucha precisión.
    12. Marcador indeleble de punta fina.
    13. Lápiz.
    14. Cautín, estaño, flux.
    15. Pinzas y alicates (este último es opcional).
    16. Lima metálica.
    17. Mesa de trabajo con buena iluminación.
    18. Amarres plásticos.
    19. Poste para montar la antena (una guadua lo más larga posible o una varilla rígida de cualquier material).
    20. Bisturí, cortador.
    21. Pelacables (opcional).
    22. Teléfono celular o módem compartido (MiFi).

---

## **¿Cómo hacerlo?**

- **Momento 0: Antes de empezar, algunas recomendaciones para tu cuidado**
...
- **Momento 1: Revisar los materiales**
