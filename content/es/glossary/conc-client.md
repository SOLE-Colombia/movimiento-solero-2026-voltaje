...
- **Rol del cliente:** El cliente envía solicitudes al servidor para acceder a datos, servicios o recursos que este proporciona.(Fuente: [IONOS](https://es.wikipedia.org/wiki/Cable_coaxial#:~:text=Un))

- **Interacción cliente-servidor:** En una arquitectura cliente-servidor, el cliente inicia la comunicación y el servidor responde a las solicitudes del cliente.(Fuente: [IONOS](https://es.wikipedia.org/wiki/Cable_coaxial#:~:text=Un))

- **Ejemplos:**
    - Un navegador web como Google Chrome o Mozilla Firefox es un cliente que solicita páginas web a un servidor. (Fuente: [Brave](https://brave.com/es/glossary/client/))
    - Un programa de correo electrónico que se conecta a un servidor para enviar y recibir mensajes es otro ejemplo. (Fuente: [Linube](https://brave.com/es/glossary/client/))
    - Un dispositivo móvil que accede a una aplicación en la nube es otro ejemplo de cliente. (Fuente: [TechTarget](https://www.techtarget.com/searchenterprisedesktop/definition/client))
- **Tipos de clientes:**
