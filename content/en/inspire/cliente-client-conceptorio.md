...
- **Rol del cliente:** El cliente envía solicitudes al servidor para acceder a datos, servicios o recursos que este proporciona. (Fuente: https://www.ionos.com/es-us/digitalguide/servidores/know-how/que-es-un-cliente/)
- **Interacción cliente-servidor:** En una arquitectura cliente-servidor, el cliente inicia la comunicación y el servidor responde a las solicitudes del cliente. (Fuente: https://www.ionos.com/es-us/digitalguide/servidores/know-how/que-es-un-cliente/)
- **Ejemplos:**
    - Un navegador web como Google Chrome o Mozilla Firefox es un cliente que solicita páginas web a un servidor. (Fuente: https://brave.com/es/glossary/client/)
    - Un programa de correo electrónico que se conecta a un servidor para enviar y recibir mensajes es otro ejemplo. (Fuente: https://linube.com/ayuda/glosario)
    - Un dispositivo móvil que accede a una aplicación en la nube es otro ejemplo de cliente. (Fuente: https://www.techtarget.com/searchenterprisedesktop/definition/client)
- **Tipos de clientes:**
    - **Clientes pesados:** Tienen capacidad de almacenamiento local y pueden ejecutar aplicaciones de forma independiente. (Fuente: https://es.slideshare.net/slideshow/clientes-informatico/54264431)
    - **Clientes ligeros:** Dependen principalmente del servidor para la ejecución de aplicaciones y el almacenamiento de datos. (Fuente: https://es.slideshare.net/slideshow/clientes-informatico/54264431)
- **Importancia:** Los clientes permiten a los usuarios acceder a una amplia gama de servicios y recursos de forma remota, facilitando la interacción con sistemas distribuidos y redes. (Fuente: https://docs.oracle.com/cd/E24842_01/html/E23289/clientconcept-33212.html)
