...
# Redireccionador DNS y servidor DHCP ligero | Dnsmasq

Fecha de creación: 22 de julio de 2025 11:49
...
**dnsmasq** es un software que proporciona almacenamiento en caché para el sistema de nombres de dominio ([DNS](/dns-sistema-de-nombres-de-dominio-dns-domain-name-system-conceptorio)), servidor de protocolo de configuración dinámica de host ([DHCP](https://es.wikipedia.org/wiki/DHCP)), enrutador de publicidad y funciones de arranque de red para pequeñas redes informáticas, creado como [software libre](https://es.wikipedia.org/wiki/Software_libre).
