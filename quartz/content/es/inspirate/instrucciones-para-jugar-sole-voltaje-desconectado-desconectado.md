...
1. **[Nutrición]: Cartas Navegadoras: ¿Qué te gustaría más? (30 min)**
...
2. **[Creación]: Cartas Cacharreras: ¿Cómo está tu señal? y Cartas Conectivas: ¿Qué quieren hacer? (30 min)**
    ...
    1. Divide el grupo en dos y escojan cualquiera de las dos cartas. Luego sigan las instrucciones para empezar a navegar. 
        ...
        2. **Si no hay señal de Internet**, ¿a dónde van a buscarlo? 
            1. Si no está muy lejos vayan a ese lugar y de nuevo sigan las instrucciones de las Cartas.
            2. Si está muy lejos la señal pueden seguir al paso 2b.
    2. Una vez hayan completado el ejercicio, compartan con el resto del grupo cuál fue la velocidad de descarga según el operador o la fuente de Wifi. 
    ...
    3. Luego cuéntales que con la señal que tienen - o no - hay varias opciones. Presenta las  **Cartas Conectivas:** les mostrarán diferentes soluciones de conectividad que podrán encontrar en la página web de **Desconectado o impresas**. 
        ...
        ¿Cuáles son las diferencias entre estas cartas? Los invitamos a abrir cualquier de ellas para descubrirlo. 
        
        Permite que cada persona escoja una solución e invítalos a que lean para presentarla al resto del grupo.
        
3. **[Exposición]:** Cada participante presenta al resto del grupo la solución que leyó y luego facilita una conversación **(30 min)**
    1.  ¿Cuál de estas soluciones le gustó más al grupo? ¿Por qué les gusto? 
    2. ¿Cuál no tanto? ¿Por qué?
    3. ¿Qué dudas surgieron leyendo las soluciones? 
    4. ¿Cuáles podríamos implementar para nuestro contexto? 
    5. ¿Qué otros contextos o comunidades conocemos que tengan retos de conectividad? ¿Cuál de esas soluciones les podría servir? 
    6. ¿Cuándo empezamos? Arrancar a hacerla es la **actitud cacharrera** que va lograr que todos nos podamos conectar a crear el mundo que queremos juntos. 
4. **[Vacío]: Por definir**