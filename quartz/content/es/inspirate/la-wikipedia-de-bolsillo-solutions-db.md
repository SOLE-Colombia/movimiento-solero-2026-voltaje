---
title: La Wikipedia de bolsillo
lang: es
slug: la-wikipedia-de-bolsillo-solutions-db
aspectos:
- señal
- electricidad
- dispositivos
...
- **Momento 5: Probamos que todo funcione**
    ...
    Y ahora... ¡¡el momento que estábamos esperando!! Vamos a visitar nuestra Wikipedia de bolsillo. En el navegador de tu computador o teléfono que esté conectado a la red local navega a la dirección `[solevoltaje.local:8080`.](http://solevoltaje.local:8080`.) Una vez cargue, puedes navegar toda la información que acabamos de descargar :D
...
- [**Una pequeña Internet de bolsillo**](https://sole-doc.tiddlyhost.com/#Una pequeña Internet de bolsillo)
- [**Un punto de acceso portátil**](https://sole-doc.tiddlyhost.com/#Un punto de acceso portátil)
- [**Wikipedia en los celulares**](https://sole-doc.tiddlyhost.com/#Wikipedia en los celulares)
