...
# ¿Cómo comprar un computador para ti?
...
- **¿Qué potencialidades tiene un computador en relación a un celular?**
...
- **Momento 0: Antes de empezar: ¡ALERTA! ¿Qué es el hardware y el software?**
    ...
    **Descripción**
    ...
    Este es el cerebro de la máquina, sin duda uno de los factores fundamentales a tener en cuenta. Recuerda que según la potencia de este elemento el equipo podrá ejecutar más rápido las instrucciones que le des.
    
    El disco duro marca la capacidad de almacenamiento de tu equipo. 
    
    La memoria RAM almacena de forma temporal los datos de las aplicaciones que se están ejecutando. Cuanta más memoria RAM tenga tu computador, mayor capacidad para ejecutar diferentes programas a la vez de forma óptima.
    
    La tarjeta gráfica se encarga del procesamiento de datos relacionados con imágenes y vídeos que se reproducen en el computador. 
...
- **Momento 1: Los criterios fundamentales**
    ...
    | Periféricos | Si armas un computador de escritorio puedes acoplarle infinidad de periféricos según tus necesidades. Por otro lado, en los portátiles la mayoría de opciones tratan de ser lo más sencillas y minimalistas posibles por lo que cada vez tienen menos entradas. | ¿Cuántos puertos USB necesitas? ¿Necesitas conectar el computador a una pantalla o TV? ¿Salidas de audio? |
    | Pantalla | La interacción con un pantalla es cada vez más recurrente, por esto es importante que te de comodidad y cuide tu vista, para esto debemos tener en cuenta:
    Tamaño: Si necesitas llevar el equipo de un lado a otro, lo ideal es 14 pulgadas, pero si tu finalidad es trabajo gráfico necesitas un mayor tamaño.
    Resolución: De nada te sirve comprar una pantalla grande con una mala resolución. A partir de 1080 es full HD y es una resolución bastante buena. Se recomiendan monitores de hasta 23’’ para evitar el efecto pixelado que provocan las imágenes con poca resolución. | ¿Cuántas pulgadas necesito?, ¿Qué resolución es suficiente para mis requerimientos?, ¿Necesitas manejar varios programas al mismo tiempo, diseñar o ver tus películas favoritas?  |
    | Batería | Este dependerá de la cantidad de celdas, cada fabricante especifica esta información y su correspondencia a cantidad de horas de independencia. | ¿Necesitas moverte con tu computadora entre sitios diferentes?, ¿Cuánto tiempo de independencia energética necesitas? |
...
- [[Guia Para Tomar Mejores Decisiones](https://www.wrike.com/es/blog/guia-para-tomar-mejores-decisiones/](https://www.wrike.com/es/blog/guia-para-tomar-mejores-decisiones/))
